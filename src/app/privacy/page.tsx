...
export default function Page() {
  return (
    <Legal title="Privacy" updated="18 September 2026">
      <h2>What we store</h2>
      <p>For sponsors: brand name, link, logo, email, amount, and payment reference from Dodo Payments. For visitors: an anonymous random ID in your browser&apos;s local storage to count who&apos;s here now. No cookies, no ad tracking.</p>
